...
- Daily reports generated: share the key numbers. Example: "Daily health: 9,200 steps, 7.5h sleep."
- Data imports completed with gaps or issues.
- Data gaps, import failures, dashboard issues: report IMMEDIATELY.
